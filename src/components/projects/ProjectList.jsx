          ...
          <div className="relative">
            ...
            {showMenu && (
              <>
                ...
                <button onClick={() => { dispatch({ type: 'DUPLICATE_PROJECT', project }); setShowMenu(false) }} className="w-full text-left px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-600">Duplicate</button>
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 px-5 py-4 flex items-center gap-4">
      ...
      <div className="flex gap-1">
        ...
        <button onClick={() => dispatch({ type: 'DUPLICATE_PROJECT', project })} className="px-2.5 py-1.5 rounded-lg text-xs text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">Duplicate</button>
