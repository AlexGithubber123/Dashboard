...
import { LayoutDashboard, FolderKanban, Moon, Sun, Plus } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 min-h-screen bg-slate-900 dark:bg-slate-950 text-slate-300">
      {/* Logo */}
